 ...
 */
export declare type Message = Buffer;
/**
 * Union type representing all message types that are accepted by
 * {@link Writable.send}().
 */
export declare type MessageLike = ArrayBufferView | ArrayBuffer | SharedArrayBuffer | string | null;
/**
...
declare type ReceiveType<T> = T extends {
 ...
 */
export declare type SocketOptions<S extends Socket> = Options<S, {
    context: Context;
}>;
